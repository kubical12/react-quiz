...
// initial state is basically the state at the starting of our app 
const initialState ={ 
  questions:[],
  status: "loading",
  index : 0,
  ...
  return (
    <div className="app">
      ...
      <Main>
        ...
        {status === "active" &&
        <>   
        <Progress index={index} numQuestions={numQuestions} points={points} maxPossible={maxPossible} answer={answer}/>
        ...
        {status === "finished" && <FinshedScreen points={points} maxPossible={maxPossible} highscore={highscore} dispatch={dispatch}/>}
      </Main>
    </div>
  );
}
